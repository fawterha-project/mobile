...
export default function EmptyCategoryCommitmentsScreen({ navigation }) {
    ...
    const loadData = async () => {
        try {
            ...
            const commitmentsReceipts = data.filter(
                item => item?.categories?.categorie_name === 'الالتزامات',
            );

            setReceipts(commitmentsReceipts);
        } catch (error) {
            console.log(error);
        }
    };
    ...
    return (
        <View style={categoryFoodStyles.container}>
            ...
            <View style={categoryFoodStyles.headerRow}>
                ...
                <Text style={categoryFoodStyles.title}>الالتزامات</Text>
            ...
            >
                <View style={categoryFoodStyles.summaryIconBox}>
                    <MaterialIcons name="event" size={42} color={colors.cyan} />
                </View>

                <View style={categoryFoodStyles.summaryInfo}>
                    <Text style={categoryFoodStyles.summaryTitle}>الالتزامات</Text>
            ...
            {filteredReceipts.length === 0 ? (
                <View style={categoryFoodStyles.emptyCategoryContent}>
                    <MaterialIcons name="event" size={82} color={colors.border} />
                ...
                filteredReceipts.map(item => (
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <MaterialIcons name="event" size={25} color={colors.cyan} />
                            </View>
                        </TouchableOpacity>
                    </InvoiceSwipeActions>
                ))

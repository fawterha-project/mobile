...
const groceriesBills = [

  {
    ...
    date: 'اليوم - 10:30 ص',
    amount: '150',
    image: { uri: 'asset:/image/panda.png' },
  },

  {
    ...
    date: 'أمس - 8:40 ص',
    amount: '120',
    image: { uri: 'asset:/image/danube.png' },
  }

];


export default function CategoryGroceriesScreen({
  navigation
}) {
    ...
    >
...

      {
        !showNotFound && (
          ...
          <View
            style={categoryFoodStyles.summaryCard}
          >

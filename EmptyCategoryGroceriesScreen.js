...
export default function EmptyCategoryGroceriesScreen({ navigation }) {
    ...
    const loadData = async () => {
        try {
            ...
            const groceriesReceipts = data.filter(
                item => item?.categories?.categorie_name === 'المقاضي',
            );

            setReceipts(groceriesReceipts);
        } catch (error) {
            console.log(error);
        }
    };
    ...
    return (
        <View style={categoryFoodStyles.container}>
            ...
            <View style={categoryFoodStyles.headerRow}>
                ...
                <Text style={categoryFoodStyles.title}>المقاضي</Text>

                <View style={categoryFoodStyles.headerSpace} />
            </View>

            <View style={categoryFoodStyles.summaryCard}>
                ...
                <View style={categoryFoodStyles.summaryInfo}>
                    <Text style={categoryFoodStyles.summaryTitle}>المقاضي</Text>

                    <Text style={categoryFoodStyles.summaryCount}>
                        {receipts.length} فواتير
                    </Text>

                    <Text style={categoryFoodStyles.summaryAmount}>
                        {totalAmount} ريال
                    </Text>

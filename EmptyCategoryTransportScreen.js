...
export default function EmptyCategoryTransportScreen({ navigation }) {
  ...
  const loadData = async () => {
    try {
      ...
      const transportReceipts = data.filter(
        item => item?.categories?.categorie_name === 'النقل',
      );

      setReceipts(transportReceipts);
    } catch (error) {
      console.log(error);
    }
  };
  ...
  return (
    <View style={categoryFoodStyles.container}>
      ...
      <View style={categoryFoodStyles.headerRow}>
        ...
        <Text style={categoryFoodStyles.title}>النقل</Text>
      ...
      >
        ...
        <View style={categoryFoodStyles.summaryInfo}>
          <Text style={categoryFoodStyles.summaryTitle}>النقل</Text>

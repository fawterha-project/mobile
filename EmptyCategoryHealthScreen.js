...
export default function EmptyCategoryHealthScreen({ navigation }) {
    ...
    const loadData = async () => {
        try {
            ...
            const healthReceipts = data.filter(
                item => item?.categories?.categorie_name === 'الصحة',
            );

            setReceipts(healthReceipts);
        } catch (error) {
            console.log(error);
        }
    };
    ...
    return (
        <View style={categoryFoodStyles.container}>
            ...
            <View style={categoryFoodStyles.headerRow}>
                ...
                <Text style={categoryFoodStyles.title}>الصحة</Text>
            ...
            >
                <View style={categoryFoodStyles.summaryIconBox}>
                    <MaterialIcons name="favorite-border" size={42} color={colors.red} />
                </View>

                <View style={categoryFoodStyles.summaryInfo}>
                    <Text style={categoryFoodStyles.summaryTitle}>الصحة</Text>
